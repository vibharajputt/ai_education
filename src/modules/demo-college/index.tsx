...
export function DemoCollegeModule() {
  const { collection, items, loading, error, reload } = useCollection('demo-college.json');
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <StateShell
        ...
        error={error}
        onRetry={reload}
        emptyTitle="No matching interview items"
      ...
      <Drawer
        ...
        title="AI Framework & Solution Guide"
      >
        {activeExplanation && (
              ...
              <div className="p-4 rounded-lg bg-[var(--color-surface)] border border-[var(--color-border)] min-h-[160px]">
                {activeExplanation.text ? (
                  ...
                  <div className="flex items-center justify-center h-28 text-xs text-[var(--color-text-muted)] gap-2">
                    ...
                    Generating framework and technical walkthrough...
                  </div>
                )}
              </div>
            </div>
